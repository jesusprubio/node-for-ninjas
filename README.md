...
[<img src="https://fsfe.org/graphics/gplv3-logo-red.png" height="40" alt="GPLv3">](https://www.gnu.org/copyleft/gpl.html)
...
- Performance
  ...
  - [NPM](https://www.npmjs.com/): **442183  (1350/day) packages** (at 25/04/2017, [today](http://www.modulecounts.com/))
- **Community driven**
...
- **Pure event oriented** implementation: Make it only with much love :):
  ...
  - A web path brute-forcer (by [@NighterMan](https://twitter.com/NighterMan))
    - https://gist.github.com/jpenalbae/46782408bebe8e61eb32
- **[async.js](https://github.com/caolan/async)**
  - New approach (also caloan): [Highland](http://highlandjs.org/) (streams)
- **Promises**: What we're going to use :).
...
- Old version [demo](https://www.youtube.com/watch?v=M-6k4Md3qEQ).
  - Refactoring almost done: https://github.com/jesusprubio/bluebox-ng
